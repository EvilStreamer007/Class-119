...
import json
import pickle #converts list/dictionaries/other objects into streams of 0s and 1s
import numpy as np
...
def create_bot_corpus(stem_words, classes):
    ...
    pickle.dump(stem_words, open('words.pkl','wb')) #wb - writing in binary mode
...
def preprocessed_traindata(training_data):
...
train_x, train_y = preprocessed_traindata(training_data)
